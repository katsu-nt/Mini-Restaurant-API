...
public class AssignUserRoleCommandHandler(ILogger<AssignUserRoleCommand> logger, UserManager<User> userManager,RoleManager<IdentityRole> roleManager) : IRequestHandler<AssignUserRoleCommand>
{
